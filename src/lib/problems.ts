...
export const problems: Problem[] = [
  {
    ...
    description: "Determine whether the array contains any duplicate values and return true if it does, false if all values are unique.",
  ...
  },
  {
    slug: "valid-anagram",
    title: "Valid Anagram",
    description: "Check whether the two strings contain exactly the same characters with the same frequencies, regardless of order, and return true or false accordingly.",
  ...
  },
  {
    slug: "two-sum",
    title: "Two Sum",
    description: "Find two distinct numbers in the array that add up to the target and return their indices, with the smaller index first.",
  ...
  },
  {
    ...
    description: "Group the strings into lists where each list contains words that are anagrams of each other, and return all such groups.",
  ...
  },
  {
    ...
    description: "Return the top K numbers that appear most often in the list; you may output them in any order.",
  ...
  },
  {
    ...
    description: "Create a method to convert a list of strings into a single string representation and another method to reconstruct the original list from that encoded string.",
  ...
  },
  {
    ...
    description: "Return a new array where each element is the product of all other elements except itself, ideally computed in linear time without using division.",
  ...
  },
  {
    ...
    description: "Find the maximum length of a streak of consecutive integers that can be formed from the array’s values (order doesn’t matter), using a linear-time approach.",
